...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.failures'
        db.add_column(u'sign_client', 'failures',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Client.complets'
        db.add_column(u'sign_client', 'complets',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.failures'
        db.delete_column(u'sign_client', 'failures')

        # Deleting field 'Client.complets'
        db.delete_column(u'sign_client', 'complets')
