...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sign_feedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('useremail', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('usertext', self.gf('django.db.models.fields.TextField')()),
            ('ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, blank=True)),
            ('useragent', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'sign', ['Feedback'])


    def backwards(self, orm):
        # Deleting model 'Feedback'
        db.delete_table(u'sign_feedback')
