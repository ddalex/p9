...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChannelRelays'
        db.create_table(u'sign_channelrelays', (
        ...
        db.send_create_signal(u'sign', ['ChannelRelays'])
    ...
    def backwards(self, orm):
        # Deleting model 'ChannelRelays'
        db.delete_table(u'sign_channelrelays')
